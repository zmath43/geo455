...
var vevey = L.marker([46.46061516322543, 6.843485469814696], {icon: myIcon, title: "Vevey"}).bindPopup("<b>Vevey</b><br>A lakeside city that is home to the bizarre Alimentarium and former home of even more bizarre Charlie Chaplin.<br><br><img src='../Pictures/Vevey.jpg' width=400/>", {maxWidth: "auto"}).addTo(myMap);
